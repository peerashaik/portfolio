...
<footer class="footer mt-5">
  <div class="container">
    ...
    <ul class="nav social">
      <li><a class="link" href="Certified-Magento2-Frontend-Developer-PeeraShaik.pdf" download="Certified-Magento2-Frontend-Developer-PeeraShaik.pdf">Download - RESUME</a></li>
      <li class="ms-2">
