...
const ASMeals = () => {
  return (
    <>
    <FadeInSection>
    <shopify-store store-domain="https://zstorefoods.myshopify.com/" public-access-tokenn="6a95b1cd24e8bb94d05669e9a6d0eadc" country="IND" language="en">
      <div className="container">
        <main className="grid">
          <shopify-list-context type="product" query="product" first="6">
            <template>
              <div className="card">
