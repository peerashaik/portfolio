  ...
  return (
    ...
    <div className="container">
      <div className="text-center my-20">
        ...
        <div className="px-10">
          <p className="mb-5">Experienced Webmaster, Web Development, and SEO Services with 23 years in IT industry, specializing in User Interface Design & Development of web applications and including WordPress, Magento2, Shopify CMS platforms for both desktop and mobile user centered interfaces.</p>
    ...
    <div className="container">
      ...
      <div className="mt-16 text-center">
        ...
        <h3 className="mt-4">HAVE A PROJECT IN MIND? LET'S DISCUSS! </h3>
      </div>
    </div>
    </FadeInSection>
